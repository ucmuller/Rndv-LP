<template>
  <div class="wrapBody">
    ...
    <div class="wrap">
        ...
        <h4>3. 個人情報の利用目的</h4>
        <p>当社は、お客様等の個人情報を、以下の目的で利用いたします。</p>
        <ol>
            <li>お客様に関する個人情報</li>
            <p>(1)「RNDV」という名称のサービスを含む当社が提供するサービス（以下「当社のサービス」といいます。）の提供、管理及び運営のため</p>
        ...
        <h4>9. 個人情報の開示</h4>
        <p>当社は、お客様から、個人情報保護法の定めに基づき個人情報の開示を求められたときは、お客様ご本人からのご請求であることを確認の上で、お客様に対し、遅滞なく開示を行います（当該個人情報が存在しないときにはその旨を通知いたします。）。なお、開示等の求めを行う場合には、お客様ご本人からのご請求であることを確認するため、以下の書類をご提出していただく必要があります。 1）運転免許証、2）パスポート3）健康保険証、4）年金手帳、5）外国人登録証などの公的書類のコピー1点。但し、個人情報保護法その他の法令により、当社が開示の義務を負わない場合は、この限りではありません。なお、個人情報の開示につきましては、手数料（1件あたり1,000円）を頂戴しておりますので、あらかじめ御了承ください。</p>
